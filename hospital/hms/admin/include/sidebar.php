							...
							<li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Caretakers </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
									<li>
										<a href="doctor-specilization.php">
											<span class="title"> Caretaker Specialization </span>
										</a>
									</li>
									<li>
										<a href="add-doctor.php">
											<span class="title"> Add Caretaker</span>
										</a>
									</li>
									<li>
										<a href="Manage-doctors.php">
											<span class="title"> Manage Caretaker </span>
										</a>
									</li>
	...
	<li>
								<a href="doctor-logs.php">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Caretaker Session Logs </span>
										</div>
									</div>
								</a>
							</li>		
