...
<html lang="en">
	<head>
		<title>Caretaker | Edit Caretaker Details</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Caretaker | Edit Caretaker Details</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Caretaker</span>
									...
									<li class="active">
										<span>Edit Caretaker Details</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Edit Caretaker</h5>
												</div>
